    ...
    const columns = [
        {
            ...
            key: 'avatar',
            width: 80,
            render: (avatar: string) => avatar ? <img src={avatar} alt="avatar" style={{ width: 40, height: 40, borderRadius: '50%', objectFit: 'cover' }} /> : '-'
        },
        {
        ...
        },
        {
            ...
            render: (hoatDong: boolean) => (
                <Switch checked={hoatDong} disabled />
            )
        },
        {
            title: 'Thao tác',
